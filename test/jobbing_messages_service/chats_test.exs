defmodule JobbingMessagesService.ChatsTest do
  use JobbingMessagesService.DataCase

  alias JobbingMessagesService.Chats

  describe "messages" do
    alias JobbingMessagesService.Chats.Message

    @valid_attrs %{account: "some account", body: "some body", room: "some room"}
    @update_attrs %{account: "some updated account", body: "some updated body", room: "some updated room"}
    @invalid_attrs %{account: nil, body: nil, room: nil}
    ...
    test "create_message/1 with valid data creates a message" do
      ...
      assert message.account == "some account"
    ...
    test "update_message/2 with valid data updates the message" do
      ...
      assert message.account == "some updated account"
